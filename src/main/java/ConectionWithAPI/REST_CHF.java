...
public class REST_CHF implements REST_NBP {
    @Override
    public Currency getCurrency() throws IOException {
        Gson gson = new Gson();
        Currency currency = gson.fromJson(String.valueOf(REST_NBP.jsonObject("http://api.nbp.pl/api/exchangerates/rates/a/chf/")), Currency.class);
